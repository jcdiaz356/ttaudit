 ...
 */
public class EvaluacionTransaccionUno extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionUno.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_uno);
    ...
    private void leerEncuesta() {
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(536);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[10]);
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                if (result==0){
                                    ...
                                    Intent intent;
                                    intent = new Intent(MyActivity,EvaluacionTransaccionDos.class);
                                    intent.putExtras(argRuta);
                                    startActivity(intent);
                                    finish();
                                }
