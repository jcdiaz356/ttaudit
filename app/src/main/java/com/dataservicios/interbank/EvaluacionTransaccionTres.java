 ...
 */
public class EvaluacionTransaccionTres  extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionTres.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_tres);
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(538);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[12]);
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Intent intent;
                                intent = new Intent(MyActivity,EvaluacionTransaccionCuatro.class);
