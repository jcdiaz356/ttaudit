...
public class EvaluacionTransaccionSeisSiete extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionSeisSiete.class.getSimpleName();
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(548);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[22]);
