 ...
 */
public class EvaluacionTransaccionNueve   extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionNueve.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_nueve);
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(544);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[18]);
