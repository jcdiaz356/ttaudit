 ...
 */
public class UsoInterbankAgenteQuinto  extends Activity {
    private static final String LOG_TAG = UsoInterbankAgenteQuinto.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_uso_interbank_agente_quinto);
    ...
    private void leerEncuesta() {
        if(db.getEncuestaCount()>0) {
            // Encuesta encuesta = db.getEncuesta(533);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[7]);
