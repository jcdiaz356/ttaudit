 ...
 */
public class UsoInterbankAgenteCuarto extends Activity {
    private static final String LOG_TAG = UsoInterbankAgenteCuarto.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_uso_interbank_agente_cuarto);
    ...
    private void leerEncuesta() {
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(532);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[6]);
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Intent intent;
                                intent = new Intent("com.dataservicios.systemauditor.USOIBKQUINTO");
