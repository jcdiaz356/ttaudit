 ...
 */
public class introduccionTres extends Activity{
    private static final String LOG_TAG = introduccionTres.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_introduccion_tres);
...
//        overridePendingTransition(R.anim.anim_slide_in_right,R.anim.anim_slide_out_right);
    ...
    private void leerEncuesta() {
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(526);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[0]);
