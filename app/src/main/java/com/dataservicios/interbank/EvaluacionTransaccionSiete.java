 ...
 */
public class EvaluacionTransaccionSiete  extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionSiete.class.getSimpleName();
    private ProgressDialog pDialog;
    private int idCompany, idPDV, idRuta, idAuditoria,idUser ;
    private JSONObject params;
    private SessionManager session;
    private String email_user, name_user,valoracionTiempo;
    private  int result,tiempo;
    Activity MyActivity = (Activity) this;
    TextView pregunta ;
    Button guardar;
    RadioGroup rgTipo;
    RadioButton rbSi,rbNo;
    EditText comentario, etTiempo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_siete);
...
//                }
                ...
                if(tiempo>=1 && tiempo<3) {
                    valoracionTiempo="Rapida";
                }
                if(tiempo>=3 && tiempo<5) {
                    valoracionTiempo="Normal";
                }
                if(tiempo>=5 && tiempo<7) {
                    valoracionTiempo="Lento";
                }
                if(tiempo>=7 ) {
                    valoracionTiempo="Muy lento";
                }
...

                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        try {
                            ...
                            paramsData.put("limite",String.valueOf(tiempo) + "|" + valoracionTiempo  );
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(542);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[16]);
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                argRuta.putInt("idAuditoria",idAuditoria);
                                    ...
                                    Intent intent;
                                    intent = new Intent(MyActivity,EvaluacionTransaccionOcho.class);
