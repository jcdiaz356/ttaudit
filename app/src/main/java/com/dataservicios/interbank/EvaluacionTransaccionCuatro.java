 ...
 */
public class EvaluacionTransaccionCuatro  extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionCuatro.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_cuatro);
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(539);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[13]);
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Intent intent;
                                intent = new Intent(MyActivity,EvaluacionTransaccionCinco.class);
