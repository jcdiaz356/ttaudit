 ...
 */
public class EvaluacionTransaccionCinco  extends Activity{
    private static final String LOG_TAG = EvaluacionTransaccionCinco.class.getSimpleName();
...
private DatabaseHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_cinco);
...
//        });
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(540);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[14]);
