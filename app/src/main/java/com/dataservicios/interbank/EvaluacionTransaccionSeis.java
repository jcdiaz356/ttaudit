 ...
 */
public class EvaluacionTransaccionSeis  extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionSeis.class.getSimpleName();
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(541);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[15]);
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                if (result==0){
                                    ...
                                    Intent intent;
                                    intent = new Intent(MyActivity,EvaluacionTransaccionSeisSiete.class);
                                    intent.putExtras(argRuta);
                                    startActivity(intent);
                                    finish();
                                }
