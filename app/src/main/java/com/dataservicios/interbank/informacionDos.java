 ...
 */
public class informacionDos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_informacion_dos);
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            Encuesta encuesta = db.getEncuesta(21);
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                argRuta.putInt("idAuditoria",idAuditoria);
                                    ...
                                    Intent intent;
                                    intent = new Intent(MyActivity,informacionTres.class);
