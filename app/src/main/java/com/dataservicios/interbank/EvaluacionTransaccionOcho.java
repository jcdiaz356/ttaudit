 ...
 */
public class EvaluacionTransaccionOcho  extends Activity {
    private static final String LOG_TAG = EvaluacionTransaccionOcho.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_evaluacion_transaccion_ocho);
    ...
    private void leerEncuesta() {
        ...
        if(db.getEncuestaCount()>0) {
            //Encuesta encuesta = db.getEncuesta(543);
            Encuesta encuesta = db.getEncuesta(GlobalConstant.poll_id[17]);
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                argRuta.putInt("idAuditoria",idAuditoria);
                                    ...
                                    Intent intent;
                                    intent = new Intent(MyActivity,EvaluacionTransaccionNueve.class);
